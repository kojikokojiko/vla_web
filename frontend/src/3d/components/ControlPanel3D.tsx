import { EXAMPLES_3D } from '../constants/examples3d'
import { Mode } from '../hooks/useVLARunner3D'
    ...
    <div style={s.box}>
      ...
      <div style={s.inputRow}>
        <input
          ...
          placeholder="e.g. Pick up the red cube and place it in Bin A"
          disabled={isRunning}
        />
        {isRunning
